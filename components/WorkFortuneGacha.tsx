    ...
    <div className="flex flex-col items-center gap-6">
      {!result && (
        <button
          ...
          onClick={draw}
          disabled={isDrawing}
          className="group relative flex h-40 w-40 items-center justify-center rounded-full bg-gradient-to-br from-sky-300 to-cyan-100 text-5xl shadow-[0_0_40px_rgba(56,189,248,0.35)] transition active:scale-95 disabled:opacity-70 sm:h-48 sm:w-48"
        >
